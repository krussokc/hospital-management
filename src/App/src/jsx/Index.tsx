...
import AddUpdateHospital from "./components/Hospital/AddNewHospital";
...
const Markup = () => {
  const routhPath: routerType[] = [
    ...
    { url: "hospitals", component: <Hospitals /> },
    { url: "teacher-detail", component: <TeachersDetail /> },
    { url: "add-teacher", component: <AddNewTeacher /> },
    ...
    <>
      <Routes>
        ...
        <Route element={<Layout2 />}>
          ...
          <Route path="/hospitals/:id/edit" element={<AddUpdateHospital />} />
        </Route>
