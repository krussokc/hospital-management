            ...
            <Row>
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="default-tab">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="custom-tab">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="nav-pills">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="nav-pills-tabs">
                    <Card.Header>
                      <div>
                        <Card.Title>Nav Pills Tabs</Card.Title>
                      </div>
...
`}
              ...
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="vertical-nav">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="vertical-nav-pill">
                    <Card.Header>
                      <div>
                        <Card.Title>Vertical Nav Pill</Card.Title>
                      </div>
...
`}
              ...
              <Col xl={12}>
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="tab-icon">
                    <Card.Header>
                      <div>
